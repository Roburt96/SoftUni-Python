...
for i in range(n_cmd):
    ...
    cmd = cmd_one + cmd_two
    if cmd == 'AddFirst':
        [row_one_numbers.add(digit) for digit in digits[2::]]
    elif cmd == 'AddSecond':
        [row_two_numbers.add(digit) for digit in digits[2::]]
    elif cmd == "RemoveFirst":
        [row_one_numbers.discard(i) for i in digits[2::]]
    elif cmd == "RemoveSeconds":
        [row_two_numbers.discard(i) for i in digits[2::]]
